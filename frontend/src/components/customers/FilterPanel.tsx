...
export const FilterPanel: React.FC<FilterPanelProps> = ({ filters, onChange, onReset }) => {
  return (
    <div className="bg-[var(--surface-card)] border border-[var(--border)] rounded-xl p-4 flex flex-wrap gap-4 items-end">
      {/* 1. Status Filter */}
      <div className="flex-1 min-w-[150px]">
        ...
        <select
          ...
          className="w-full px-3 py-2 border border-[var(--border)] rounded-lg text-sm bg-white focus:outline-none focus:border-[var(--teal-border)]"
        >
