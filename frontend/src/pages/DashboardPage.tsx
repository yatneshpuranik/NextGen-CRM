...
export const DashboardPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {showSettings && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 bg-[var(--surface-hover)] p-6 rounded-xl border border-[var(--border)]">
          ...
          <div className="content-card space-y-3">
            ...
            {user?.role === 'ADMIN' ? (
              ...
              <p className="text-xs text-[var(--text-muted)] py-4">
                Administrators privileges required to construct user profiles.
              </p>
            )}
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {/* Low Stock Warning Alarm board (2 cols) */}
        <div className="lg:col-span-2 content-card space-y-4">
          <div className="flex justify-between items-center">
